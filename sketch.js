...
//the setup function
function setup() {
  //the createCanvas funciton
  createCanvas(windowWidth, windowHeight);
  
  //creating the sun
  sun = createSprite(60,100,10,10);
  sun.addAnimation("sun", sunImage);
  sun.scale = 0.1
  
  //creating the invisible ground
  invisibleGround = createSprite(width/2,height-10,width,125);  
  invisibleGround.shapeColor = rgb(0,0,0);
  
  //creating the trex
  trex = createSprite(50,(invisibleGround.y-100),20,50);
...
function draw() {
  ...
  //making the trex touch the ground
